...
// Everything above was copied and pasted from the class lab
// This is a test of an configuration file that I copied from here:
// http://kbeezie.com/caching-wordpress/3/
TEST(NginxConfigParserTest, InternetConfig) {
  NginxConfigParser parser;
  NginxConfig out_config;

  bool success = parser.Parse("wordPressConfigFile", &out_config);
